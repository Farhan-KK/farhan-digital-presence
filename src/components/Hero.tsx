    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in relative z-10">
        <img 
          ...
          alt="MUHAMMED FARHAN"
          className="w-40 h-40 md:w-96 md:h-96 lg:w-[420px] lg:h-[420px] mx-auto rounded-full object-cover border-4 border-white shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"></img> 
      </div>
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in relative z-10">
